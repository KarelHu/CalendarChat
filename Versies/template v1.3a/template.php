	...
	<body>
		<div id="fullscreen">
			...
			<div class="sidebar" id="small">
				...
				<img class="icon" src="icons/addCategory.png" width="55px" style="margin-top:5px; margin-bottom:5px; cursor: pointer;" onclick="addCategory();"></img>					
			</div>
			...
			<div class="sidebar" id="expansion">
				...
				<h3 class="iconText" style="margin-bottom: 32px;">Chats</h3>
				<h3 class="iconText">Nieuwe categorie</h3>
			</div>
