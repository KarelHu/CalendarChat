	...
	<body>
		<div id="fullscreen">
			...
			<div class="sidebar" id="small">
				<img id="shrinkButton" src="icons/shrink.png"  width="45px" style="margin-top:15px; margin-bottom:5px"onclick="expansion()"></></img>
				<img id="expandButton" src="icons/expand.png"  width="45px" style="margin-top:15px; margin-bottom:5px"onclick="expansion()"></img>
			</div>
